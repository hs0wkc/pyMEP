...
def characteristic_velocity(L_char: Quantity, beta: Quantity, T_surf: Quantity, T_inf: Quantity, g_: Quantity | None = None) -> Quantity:
    """Returns the characteristic buoyancy velocity for a natural convection problem
    ...
    beta: Quantity
        Volumetric thermal expansion coefficient, evaluated at the average fluid
        emperature. For an ideal gas, it is the inverse of its absolute temperature.
    T_surf: Quantity
...
def reynolds_number(rho: Quantity, mu: Quantity, L_char: Quantity, u_char: Quantity) -> float:
    ...
    u_char: Quantity
        Characteristic buoyancy velocity.
    L_char: Quantity
        Characteristic length of the object over which the flowing fluid is passing.
...
def prandtl_number(rho: Quantity, mu: Quantity, k: Quantity, cp: Quantity) -> float:
