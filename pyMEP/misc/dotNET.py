...
"""
class Wpf(Window):
	def _LoadComponent(self, xaml_file):
		# Define namespaces
		namespaces = {'x': 'http://schemas.microsoft.com/winfx/2006/xaml',
					   '': 'http://schemas.microsoft.com/winfx/2006/xaml/presentation'}
		# Parse the XAML file
		root = parse(xaml_file).getroot()
	...
	def __init__(self, xaml_file):
		self.window = XamlReader.Load(StreamReader(xaml_file).BaseStream)
		self._LoadComponent(xaml_file)

class Wpf2(Window):
	def _LoadComponent(self, xaml_str):
		# Define namespaces
		namespaces = {'x': 'http://schemas.microsoft.com/winfx/2006/xaml',
					   '': 'http://schemas.microsoft.com/winfx/2006/xaml/presentation'}
		# Parse the XAML file
		root = parse(io.StringIO(xaml_str))
